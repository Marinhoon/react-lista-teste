...
const createTagSchema = z.object({
  title: z.string().min(3, { message: 'Precisa preencher o campo!' }),
})
  ...
  return (
    <form onSubmit={handleSubmit(createTag)} className="w-full space-y-6">
      <div className="space-y-2">
        <label className="text-sm font-medium block" htmlFor="title">Nome completo</label>
        <input 
          {...register('title')}
          id="name" 
          type="text" 
      ...
      <div className="space-y-2">
        <label className="text-sm font-medium block" htmlFor="slug">Valor a depositar</label>
        <input 
          id="slug" 
          type="text" 
          readOnly 
